...
<!-- BEGIN: Personal Information -->
    <div class="intro-y box mt-5">
        ...
        <form action="{{ route('cad-cargo') }}" enctype="multipart/form-data" data-single="true" method="post">
            <div class="p-5">
                ...
                <div class="grid grid-cols-12 gap-x-5">
                    ...
                    @csrf
                    <input type="hidden" name="id_subsetor" value="{{$idsubsetor}}">
                ...
                <div class="flex justify-end mt-4">
                    <button type="submit" class="btn btn-primary w-40 mr-auto">Cadastrar Cargo</button>
                </div>
            </div>
        </form>
    </div>
