...
<!-- BEGIN: Personal Information -->
    <div class="intro-y box mt-5">
        ...
        <form action="{{ route('upd-rodape') }}" enctype="multipart/form-data" data-single="true" method="post">
            <div class="p-5">
                ...
                <div class="grid grid-cols-12 gap-x-5">
                    ...
                    <div id="preview_empresa" class="mt-4"><img src="/fotos-empresa-rodape/{{$rodape->foto}}"></div>
                </div>
                                    
                    <button type="submit" class="btn btn-primary w-40 mr-auto" style="margin-top:10px">Atualizar Rodapé</button>
