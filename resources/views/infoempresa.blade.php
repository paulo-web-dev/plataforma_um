...
@section('content')
 ...
 <div class="intro-y flex items-center mt-8 ">
    ...
    <div class="flex-wrap">
        ...
        <a href="{{ route('infodashboard', ['id' => $empresa->id]) }}" class="btn btn-primary shadow-md mr-2" style="margin: 5px"><i data-feather="plus" class="w-4 h-4 mr-2"></i> Dashboard Gerencial</a>
