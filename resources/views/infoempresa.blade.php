...
<div class="intro-y box mt-5">
    <div class="flex items-center p-5 border-b border-gray-200 dark:border-dark-5">
        <h2 class="font-medium text-base mr-auto">
            <a href="javascript:;" data-theme="light" class="tooltip" title="Média Geral de Todas as Categorias">
                Resultado Geral da Pesquisa
                {{-- Exibe a quantidade de respondentes totais --}}
                <span class="text-gray-600 ml-2">({{ $totalParticipantesGeral }} respondente(s))</span>
                <i data-feather="bar-chart-2" class="w-4 h-4 ml-2 inline-block"></i>
            </a>
        </h2>
    </div>
    <div class="p-5">
                            ...
                            @foreach ($mediasGerais as $dado)
                                <tr class="hover:bg-gray-200">
                                    ...
                                    <td class="border text-center">
                                        {{-- Removi os IFs e usei a cor que você já define no controller para simplificar --}}
                                        @php
                                            $corFundo = '#ccc';
                                            $corTexto = '#000';
