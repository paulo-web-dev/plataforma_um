...
<head>
  ...
  <title>BPC LOAS - BETETE SGOTTI ADVOGADOS</title>
...
<body>
  ...
  <main id="main">
    ...
    <section id="cta" class="cta">
      <div class="container" data-aos="zoom-in" style="max-height: 200px;">
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 content" data-aos="fade-right">
            ...
            <h3>Pedido de BPC/LOAS.</h3>
            <p class="fst-italic">
              Para ter direito ao benefício, é necessário ter baixa renda e se enquadrar em uma das seguintes hipóteses:"
            </p>
            <ul>
              <li><i class="bi bi-check-circle"></i>Ser pessoa idosa (a partir de 65 anos).</li>
              <li><i class="bi bi-check-circle"></i> Com deficiência.</li>
              <li><i class="bi bi-check-circle"></i> Crianças e adolescentes orfãos de mãe vitima de feminicídio.</li>
            </ul>
    ...
    <section id="contact" class="contact">
      <div class="container">
        ...
        <div class="row" data-aos="fade-up">
          ...
          <div class="col-lg-6 ">
            <iframe class="mb-4 mb-lg-0" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d959.438330433458!2d-50.09309421049034!3d-20.851889300035186!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x9497d5a62cb176db%3A0xd6cad06c47fe7a09!2sBetete%20advocacia!5e0!3m2!1spt-BR!2sbr!4v1704590729667!5m2!1spt-BR!2sbr" frameborder="0" style="border:0; width: 180%; height: 384px;" allowfullscreen></iframe>
          </div>
