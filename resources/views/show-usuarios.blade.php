...
@section('content')
    ...
    <div class="grid grid-cols-12 gap-6 mt-5">
        ...
        @foreach ($usuarios as $usuario)
                ...
                <div class="box h-72">
                    ...
                    <div class="flex items-start px-5 pt-5">
                        ...
                        <div class="w-full flex flex-col lg:flex-row items-center">
                            ...
                            <div class="lg:ml-4 text-center lg:text-left mt-3 lg:mt-0">
                                ...
                                <a href="{{route('info-usuario', ['id' => $usuario->id])}}"

                                    class="font-medium">{{ $usuario->name }}</a>

                                <div class="text-gray-600 text-xs mt-0.5">{{ $usuario->email }}</div>
                            ...
                            <div class="dropdown-menu w-40">
                                ...
                                <div class="dropdown-menu__content box dark:bg-dark-1 p-2">
                                    ...
                                    <a href="javascript:;" data-toggle="modal"
                                        ...
                                        data-target="#excluirProfessor{{ $usuario->id }}"
                    ...
                    <div class="text-center lg:text-left p-5">
                        ...
                        <div class="flex items-center justify-center lg:justify-start text-gray-600 mt-5"> <i
                                ...
                                data-feather="mail" class="w-3 h-3 mr-2"></i> {{ $usuario->email }} </div>
            ...
            <div id="excluirProfessor{{ $usuario->id }}" class="modal" tabindex="-1" aria-hidden="true">
