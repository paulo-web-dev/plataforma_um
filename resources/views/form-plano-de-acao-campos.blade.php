...
<!-- BEGIN: Personal Information -->
    <div class="intro-y box mt-5">
        ...
        <form action="{{ route('cad-plano-de-acao') }}" enctype="multipart/form-data" data-single="true" method="post">
            <div class="p-5">
                    ...
                    <div class="col-span-12 xl:col-span-6">
                        ...
                        <div class="mt-3">
                            ...
                            <input id="update-profile-form-7" type="text" name="exigencia" class="form-control" required
                                placeholder="Exigência da Atividade" value="">
                        </div>
                        ...
                        <div class="mt-3">
                            ...
                            <input id="update-profile-form-7" type="text" name="recomendacao" class="form-control" required
                                placeholder="Recomendação" value="">
                        </div>
