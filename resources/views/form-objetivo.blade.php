...
<!-- BEGIN: Personal Information -->
    <div class="intro-y box mt-5">
        ...
        <form action="{{ route('cad-objetivo') }}" enctype="multipart/form-data" data-single="true" method="post">
            <div class="p-5">
                ...
                <div class="flex justify-end mt-4">
                    <button type="submit" class="btn btn-primary w-40 mr-auto">Cadastrar Objetivo</button>
                </div>
            </div>
        </form>
    </div>
