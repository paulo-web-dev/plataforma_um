                ...
                <div class="grid grid-cols-12 gap-x-5">
                    ...
                    <div class="col-span-12 xl:col-span-6">
                         ...
                         <div class="mt-3"  id="link">
                            ...
                            <input type="text" class="form-control editor" name="recomendacao" placeholder="Recomendação" value="{{$recomendacao->recomendacao}}">
                        </div>
                    
                <div class="flex justify-end mt-4">
                    <button type="submit" class="btn btn-primary w-40 mr-auto">Atualizar Recomendação</button>
                </div>
            </div>
        </form>
    </div>
