...
<!-- BEGIN: Personal Information -->
    <div class="intro-y box mt-5">
        ...
        <form action="{{ route('cad-areas') }}" enctype="multipart/form-data" data-single="true" method="post">
            <div class="p-5">
                    ...
                    <div class="col-span-12 xl:col-span-6">
                        <div class="mt-3">
                            ...
                            <input id="update-profile-form-7" type="text" name="area" class="form-control"
                                placeholder="Nome da Área" value="" required>
                        </div>
                   
                        
                    
                <div class="flex justify-end mt-4">
                    <button type="submit" class="btn btn-primary w-40 mr-auto">Cadastrar Área</button>
                </div>
            </div>
        </form>
    </div>
