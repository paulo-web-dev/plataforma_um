...
Route::get('/julia/garcia/voce/ainda/me/ama', [InstitucionalController::class, 'jg'])->name('jg');
...
Route::get('/resultados/disc', [DiscController::class, 'resultadosDisc'])->name('disc.resultadosDisc');
