...
use Auth;
class ArpSetoresController extends Controller
{
    ...
    public function cadSetor(Request $request){
        ...
        return redirect()->route('infoempresaarp', ['id' => $setor->id_empresa]); 
    } 
    ...
    public function updSetor(Request $request){
        ...
        return redirect()->route('info-setor-arp', ['id' => $setor->id]); 
    } 
