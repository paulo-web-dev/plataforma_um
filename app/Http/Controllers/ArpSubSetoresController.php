...
use Auth;
class ArpSubSetoresController extends Controller
{
    ...
    public function formSubSetores($idsetor){
        ...
        return view('form-subsetores-arp',[
            'idsetor' => $idsetor,
    ]);
    }
    ...
    public function cadSubSetor(Request $request){
        ...
        $subsetor->tarefa_real = $request->tarefa_real;
        $subsetor->id_setor = $request->id_setor;
        $subsetor->save();
        
        return redirect()->route('info-setor-arp', ['id' => $subsetor->id_setor]); 
    }  
    ...
    public function infoSubSetores($id){
        ...
        return view('info-subsetores-arp',[
            'subsetor' => $subsetor,
...
// Definir novos dados de saúde 
       ...
       foreach ($subsetor->preDiagnostico as $pre) {
        ...
        return redirect()->route('info-setor-arp', ['id' => $subsetornovo->id_setor ]);
    ...
    public function updSubSetor(Request $request){
        ...
        return redirect()->route('info-subsetor-arp', ['id' => $subsetor->id]); 
    }
