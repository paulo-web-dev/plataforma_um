...
class EmpresaController extends Controller
{
    ...
    public function infodashboard($id){
    ...
    public function dashboardarpnimprime($id){
    ...
    if ($arp->isNotEmpty()) {
        ...
        return view('dashboardempresaarpnimprime',
        [   
            'empresa' => $empresa, 
            'mediasGerais' => $mediasGerais,
            'totalParticipantesGeral' => $totalParticipantesGeral,
